...
// The fsm16bit module uses the enable pulse and the switch inputs to determine its next synchronous state.
   ...
   seven_segment_driver_aep227 hex_drive_3(count[15:12], HEX3);
   seven_segment_driver_aep227 hex_drive_2(count[11:8], HEX2);
   seven_segment_driver_aep227 hex_drive_1(count[7:4], HEX1);
   seven_segment_driver_aep227 hex_drive_0(count[3:0], HEX0);
